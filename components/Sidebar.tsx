  ...
  return (
    ...
    <CommandList>
      ...
      <CommandGroup heading="Suggestions">
        <CommandItem><LayoutDashboard className='mr-2 h-4 w-4'/><Link href="/dashboard">Dashboard</Link></CommandItem>
        <CommandItem><Newspaper className='mr-2 h-4 w-4'/><Link href="/posts">Posts</Link></CommandItem>
        <CommandItem><Folders className='mr-2 h-4 w-4'/><Link href="/categories">Categories</Link></CommandItem>
      </CommandGroup>
      <CommandSeparator />
